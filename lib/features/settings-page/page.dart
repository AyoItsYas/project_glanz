...
import 'package:path/path.dart'
    as path; // Alias the path package to avoid name conflicts
...
class _SettingsState extends State<Settings> {
  ...
  String _weatherLocation = 'Colombo'; // Default weather location
  ...
  // Reset app data and clear the database
  ...
  // Show the popup to change the weather location
  void _showLocationDialog() {
    TextEditingController _locationController = TextEditingController();
    _locationController.text =
        _weatherLocation; // Pre-fill with the current location

    showDialog(
      context: context, // Directly use the current context
      builder: (context) {
        return AlertDialog(
        ...
        child: Column(
          ...
          children: <Widget>[
            CoolCard(
              ...
              isRotatable: true,
              bottomText: _username, // Display the fetched username here
